...
console.log("El ressultado de 56 + 4 = " + suma(56, 4) );
...
//parameters => operation; --para un dato y no lleva parentesis

//(param1, param2) => {          --para más de dos datos y lleva parentesis y corchetes
//return data
//};
